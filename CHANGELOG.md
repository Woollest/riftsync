...
- おすすめ理由テンプレートを10種類から22種類へ拡張し、既存シナジーデータの理由タイプをロール別に再割り当て
- `pnpm check:recommendations` を追加し、ロール単位のおすすめ固定化を自動検証
- データをPatch 16.13.1 / Emerald+へ更新し、新チャンピオンLockeを反映
- OP.GGシナジー取得範囲を各ロール上位5件へ拡張し、LoLalyticsをセカンダリ確認元として追加
